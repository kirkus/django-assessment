    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order', models.IntegerField(default=0)),
                ('assessment', models.ForeignKey(related_name='questions', to='django_assessment.Assessment', on_delete=models.CASCADE)),
                ('option_set', models.ForeignKey(blank=True, null=True, to='django_assessment.OptionSet', on_delete=models.SET_NULL)),
            ],
            options={
                'ordering': ['order'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('assessment', models.ForeignKey(related_name='responses', to='django_assessment.Assessment', on_delete=models.CASCADE)),
                ('question', models.ForeignKey(to='django_assessment.Question', on_delete=models.CASCADE)),
        ...
        migrations.AddField(
            model_name='question',
            name='type',
            field=models.ForeignKey(to='django_assessment.QuestionType', on_delete=models.CASCADE),
        ),
        migrations.AddField(
            model_name='option',
            name='option_set',
            field=models.ForeignKey(related_name='options', to='django_assessment.OptionSet', on_delete=models.CASCADE),
        ),
